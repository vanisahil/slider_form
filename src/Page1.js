...
import hero from "./image/photo-1563460716037-460a3ad24ba9@2x.png"
  ...
  return (
    <div className='w-screen h-screen bg-[#FDE3D9] relative'>
      ...
      <div className='ml-10 mt-32 '>
        <h1 className='font-bolder text-4xl text[#3E3E3E]'>Lorem Ipsum is simply <br /> dummy text of the printing <br /> and typesetting industry.</h1>
